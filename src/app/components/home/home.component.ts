      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-6">
          ...
          >
            ...
            <div 
              class="relative bg-white rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-lg transition-shadow aspect-[3/4]"
            ...
            >
              <div class="w-full h-full flex items-center justify-center">
                ...
                >
                <div *ngIf="!pdf.coverImage" class="w-full h-full bg-red-600 flex items-center justify-center">
        ...
        <div *ngIf="pdfs.length === 0" class="text-center py-12">
